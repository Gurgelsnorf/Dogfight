...
(define ($Airplane_Key_Controlls_Handler event)
  (let
    ...
    (cond
      ...
      ((eq? £Key_Code #\s) (send *player_2* $Set_Activate_Shoot #t))
      ((eq? £Key_Code #\r) (send *start_clock* $Set_Clock_Run #t))
      ((eq? £Key_Code 'escape) (send *start_clock* $Set_Clock_Run #f))
      ((eq? £Key_Code #\e) ($Spawn_Player *player_2*))
      ((eq? £Key_Code 'rshift) ($Spawn_Player *player_1*)))
    (cond
      ...
      ((eq? £Key_Release_Code #\s) (send *player_2* $Set_Activate_Shoot #f))
